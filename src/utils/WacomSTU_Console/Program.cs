...
class Program
{
    ...
    static int timeoutSeconds = 30; // timeout seconds
    ...
    static void Main(string[] args)
    {
        ...
        // comprobar si m_tablet esta conectada
        ...
        inactivityTimer.Elapsed += OnTimeout;
        inactivityTimer.AutoReset = false; // importante
    ...
    static void OnTimeout(object sender, ElapsedEventArgs e)
    {
        Console.WriteLine("Timeout por inactividad.");
    ...
    static void OnPenData(IPenData penData)
    {
        ...
        if (pixelY < m_capability.screenHeight - buttonAreaHeight)
        {
    ...
    public static void WriteStatus(string message)
    {
        try
        {
            string statusFilePath = "C:\\Users\\Jose A\\Desktop\\momook_signature\\data\\Techlogs\\signature\\WacomStatus.txt";
            // Si existe, borrarlo
    ...
    static void ProcessSignature()
    {
        ...
        */
        ...
        string path = "C:\\Users\\Jose A\\Desktop\\momook_signature\\data\\Techlogs\\signature\\signature.png";
